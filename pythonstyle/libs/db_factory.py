        ...
        if key not in DbFactory._database:
            ...
            if datasource == 'mysql':
                ...
                db.bind(
                    ...
                    passwd=datasource_config['password'],
                    db=datasource_config['db'],
                    charset='utf8mb4')
            if datasource == 'sqlite':
                ...
                if pos != -1:
                    db.bind(
                        provider='sqlite',
                        filename=datasource_config['filename'],
                        create_db=datasource_config['create_db'])
                else:
                    db.bind(
                        provider='sqlite',
                        filename=datasource_config['filename'])
